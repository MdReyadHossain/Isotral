<?php include("../../Models/dbMemberRepo.php") ?>
...
<head>
    ...
    <link rel="icon" type="image/png" href="../../panel-asset/img/favicon.png">
    <title>
        Isotral
    </title>
    <!--     Fonts and icons     -->
...
<body class="g-sidenav-show bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start" id="sidenav-main">
        <?php include("../components/memberSidebar.php"); ?>
    </aside>
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item dropdown ps-2 d-flex align-items-center">
                            <a href="javascript:;" class="nav-link text-body p-0" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false" title="<?php echo $_SESSION["name"]; ?>">
                                <img src="../../panel-asset/img/patient.png" class="avatar avatar-sm" alt="avatar" />
                            </a>
        ...
        <div class="container-fluid py-4 px-5">
            <div class="row">
                <div class="col-md-12">
                    <div class="d-md-flex align-items-center mb-3 mx-2">
                        ...
                        <div class="ms-auto">ID: <?php echo "ISO-" . $_SESSION["id"] ?></div>
                    </div>
                </div>
            </div>
            <hr class="my-0">
            <div class="container-fluid py-2">
                                    ...
                                    <div class=''>
                                        <p class='text-dark text-sm mb-0 font-weight-bold'>
                                            ...
                                            if ($appointmentConfirm["name"] != "")
                                                ...
                                                echo "For set an appointment or meet with doctor <b class=''>today</b>, Click on <b class='text-lg'>Quick Meet</b> button. <br><span class='text-dark text-sm text-lighter'>(For other day, Go To <a class='font-weight-bolder text-primary' href='appointment'>Appointment</a> tab)</span>";
                                            ?>
                                        </p>
                                        <h5 class='font-weight-bolder'>
                                            <?php
                                            if ($appointmentConfirm["name"] != "")
                                                echo date('d-m-Y', strtotime($appointmentConfirm["appointment_at"])) . " <br>" . date("g:i A", strtotime($appointmentConfirm["appointment_time"]));
                                            ?>
                                        </h5>
                                        <p class='mb-0'>
                                ...
                                <div class='col-lg-4 text-end'>
                                    <div class='shadow-primary text-center'>
                                        ...
                                        if ($appointmentPending["name"] != "") {
                                            echo "
                                                <a href='../../Controller/patient/appointmentCancelController?appointment=" . $appointmentPending['id'] . "' type='button' class='btn btn-danger btn-sm  btn-icon d-flex justify-content-center ms-md-auto mb-2 mr-4 p-2 w-lg-25 w-md-25'>
                                                    <span class='btn-inner--text text-center'>Cancel</span>
                                                </a>
                                            ";
                                        } else if ($appointmentPending["name"] == "" && $appointmentConfirm["name"] == "") {
                                            echo "
                                                <a type='button' href='../../Controller/patient/appointmentNowController?id=" . $_SESSION['id'] . "' class='btn btn-primary btn-sm d-flex justify-content-center ms-lg-auto mb-2 mr-4 px-4 w-lg-25 w-md-auto'>
                                                    <span class='btn-inner--text'>Quick Meet</span>
                                                </a>
                                            ";
                                        }
                                        ?>
                ...
                <div class="row g-5 mb-5">
                    <div class="col-lg-4">
                        <div class="bg-light rounded d-flex flex-column align-items-center justify-content-center text-center" style="height: 250px;">
                    ...
                    <div class="col-lg-4">
                        <div class="bg-light rounded d-flex flex-column align-items-center justify-content-center text-center" style="height: 250px;">
                            ...
                            ?>
                                <div class="my-1" style="border: 0; width: 80%; height: 1px;background: #333; background-image: linear-gradient(to right, #ccc, #333, #ccc);"></div>
                                <a href="tel:<?php echo $doc["phone2"] ?>">
                                    <h6 class="mb-0"><?php echo $doc["phone2"] ?></h6>
                                </a>
                            <?php
                            }
                            ?>
