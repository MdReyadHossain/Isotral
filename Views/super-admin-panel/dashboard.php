<?php
include("../../Models/dbSuperAdminRepo.php");
...
function memberID($data)
{
    ...
    $id = str_pad($data['id'], 4, '0', STR_PAD_LEFT);
    return "ISO-" . $id . "-" . $year;
}
?>
...
<head>
    ...
    <link href="../../panel-asset/css/nucleo-svg.css" rel="stylesheet" />
    <!-- CSS Files -->
    <link id="pagestyle" href="../../panel-asset/css/argon-dashboard.css?v=2.0.4" rel="stylesheet" />
...
<body class="g-sidenav-show bg-gray-100">
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 fixed-start " id="sidenav-main">
        <?php include("../components/super-admin/sidebar.php"); ?>
    </aside>
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                        <div class="input-group">
                            <h6 class="font-weight-bolder text-white mb-0">Super Admin Panel</h6>
                        </div>
                    </div>
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item ps-2 d-flex align-items-center dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                                ...
                                <li class="">
                                    <a class="dropdown-item border-radius-md" href="editBannerImage">
                                        <div class="d-flex">
                                            <div class="my-auto">
                                                <i class="fas fa-images text-success text-sm opacity-10 border-radius-sm me-3"></i>
                                            </div>
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="text-sm font-weight-normal">
                                                    <span class="text-dark font-weight-bold">Change Banners</span>
                                                </h6>
                                            </div>
                                        </div>
                                    </a>
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <p class="mb-0">
                                        <span class="text-success text-sm font-weight-bolder">Total Reserve Amount of Isotral</span>
                                    </p>
                                </div>
                            </div>
                            <div class="col-4 text-end">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <p class="mb-0">
                                        <span class="text-success text-sm font-weight-bolder">Isotral and Child Company</span>
                                    </p>
                                </div>
                            </div>
                            <div class="col-4 text-end">
