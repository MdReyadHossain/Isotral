<div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="../../">
        <table>
            <tr>
                <td>
                    <img src="../../asset/logo/Isotral-logo.png" class="navbar-brand-img" alt="main_logo">
                </td>
            </tr>
        </table>
    </a>
...
<div class="collapse navbar-collapse w-auto" style="color: white; height: 700px;" id="sidenav-collapse-main">
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link text-white" href="appointment" id="appointment">
                <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                    <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <li class="nav-item">
            <a class="nav-link text-white" href="treatmentDetails" id="treatmentDetails">
                <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link text-white" href="contact" id="contact">
                <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                    <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <title>Contact</title>
        ...
        <li class="nav-item">
            <a class="nav-link text-white" href="healthedu" id="healthedu">
                <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                    <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <span class="nav-link-text ms-1">Oral Health</span>
            </a>
        </li>
