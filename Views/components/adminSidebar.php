<div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="../../">
        <table>
            <tr>
                <td>
                    <img src="../../panel-asset/img/favicon.png" class="navbar-brand-img" alt="main_logo">
                </td>
                <td>
...
<div class="collapse navbar-collapse  w-auto " style="height: 700px;" id="sidenav-collapse-main">
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="appointment" id="appointment">
                <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link " href="manages" id="message">
                <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fas fa-tasks text-primary text-sm opacity-10"></i>
                </div>
                <span class="nav-link-text ms-1">Manages</span>
            </a>
        </li>
