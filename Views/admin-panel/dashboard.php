                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item ps-2 d-flex align-items-center dropdown">
                            <a href="javascript:;" class="nav-link text-body p-0" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="../../panel-asset/img/profile.jpg" class="avatar avatar-sm" alt="avatar" />
                            </a>
                                                ...
                                                echo "
                                                    <tr>
                                                        <td class='align-middle text-center text-sm'>
                                                            <span class='text-xs text-secondary mb-0'>" . chamberID($data['default_chamber']) . $data['id'] . "</span>
                                                        </td>
                                                        <td>
